...
_$AppState$Impl _$$AppState$ImplFromJson(Map<String, dynamic> json) => _$AppState$Impl(
      ...
      currentWeather: json['currentWeather'] == null
          ...
          : CurrentWeather.fromJson(json['currentWeather'] as Map<String, dynamic>),
      forecastWeather: json['forecastWeather'] == null
          ? const ForecastWeather(city: City(coord: Coord()))
          : ForecastWeather.fromJson(json['forecastWeather'] as Map<String, dynamic>),
      airPollutionData: json['airPollutionData'] == null
          ? const AirPollutionData(coord: Coord())
          : AirPollutionData.fromJson(json['airPollutionData'] as Map<String, dynamic>),
      isLoadingAirPollution: json['isLoadingAirPollution'] as bool? ?? false,
      isLoadingCurrentWeather: json['isLoadingCurrentWeather'] as bool? ?? false,
      isLoadingForecastWeather: json['isLoadingForecastWeather'] as bool? ?? false,
