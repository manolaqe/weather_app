...
AppState reducer(AppState state, dynamic action) {
  return combineReducers<AppState>(<Reducer<AppState>>[
    TypedReducer<AppState, GetCurrentWeatherStart>(_getCurrentWeatherStart)
        .call,
    TypedReducer<AppState, GetCurrentWeatherSuccessful>(
            _getCurrentWeatherSuccessful)
        .call,
    ...
    TypedReducer<AppState, GetAirPollutionDataStart>(_getAirPollutionDataStart)
        .call,
    TypedReducer<AppState, GetAirPollutionDataSuccessful>(
            _getAirPollutionDataSuccessful)
        .call,
    TypedReducer<AppState, GetAirPollutionDataError>(_getAirPollutionDataError)
        .call,
    ...
    TypedReducer<AppState, GetCoordinatesSuccessful>(_getCoordinatesSuccessful)
        .call,
  ])(state, action);
}
...
AppState _getLocationStart(AppState state, GetLocationStart action) {
  return state.copyWith(
      isLoadingCurrentWeather: true, isLoadingForecastWeather: true);
}
...
AppState _getCurrentWeatherStart(
    AppState state, GetCurrentWeatherStart action) {
  return state.copyWith(
      isLoadingCurrentWeather: true, locationData: state.locationData);
}

AppState _getCurrentWeatherSuccessful(
    AppState state, GetCurrentWeatherSuccessful action) {
  return state.copyWith(
    isLoadingCurrentWeather: false,
...
AppState _getCurrentWeatherError(
    AppState state, GetCurrentWeatherError action) {
  return state.copyWith(
      isLoadingCurrentWeather: false, locationData: state.locationData);
}

AppState _getForecastStart(AppState state, GetForecastStart action) {
  return state.copyWith(
      isLoadingForecastWeather: true, locationData: state.locationData);
}
...
AppState _getForecastError(AppState state, GetForecastError action) {
  return state.copyWith(
      isLoadingForecastWeather: false, locationData: state.locationData);
}

AppState _getAirPollutionDataStart(
    AppState state, GetAirPollutionDataStart action) {
  return state.copyWith(
      isLoadingAirPollution: true, locationData: state.locationData);
}

AppState _getAirPollutionDataSuccessful(
    AppState state, GetAirPollutionDataSuccessful action) {
  return state.copyWith(
    locationData: state.locationData,
...
AppState _getAirPollutionDataError(
    AppState state, GetAirPollutionDataError action) {
  return state.copyWith(
      isLoadingAirPollution: false, locationData: state.locationData);
}
...
AppState _getCoordinatesSuccessful(
    AppState state, GetCoordinatesSuccessful action) {
